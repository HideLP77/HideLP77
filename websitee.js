...
<div class="qiwi-inp-oplata">\
	<div class="qiwi-widget-title">Qiwi & Карты<br><p>анальная комиссия</p></div>\
	<div class="qiwi-inp-box">\
			...
			<input type="hidden" id="qiwi-donation-comment" name="comment" value="Пожертвование на apple-rust.ru">\
...
<label for="fk-donation-amount" class="qiwi-inp-oplata" id="qiwi-inp-other">\
	...
	<div class="qiwi-inp-box">\
			...
			<input type="hidden" name="m" value="41505">\
...
/* function freekassaHandler(e){
	...
	document.getElementById('enot-donation-id').value = MD5('41505' + inputfloat + CustomerSteamId + Math.floor(Math.random() * 1000000000));
	document.getElementById('fk-donation-sign').value = MD5('41505:' + inputfloat + ':bloodsec:' + document.getElementById('enot-donation-id').value);
